...
if __name__ == '__main__':
    ...
    model = build_bert_model("Bert/bert_config.json", "../../bert/Bert/bert_model.ckpt", 10)
    plot_model(model, to_file='../demo/bert_intent_recognition/Bert_model.png', show_shapes=True, show_layer_names=True)
