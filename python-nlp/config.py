...
'''
MATCH (d:`疾病`)-[:has_symptom]->(s1:`症状` {name: "腹痛"})
MATCH (d:`疾病`)-[:has_symptom]->(s2:`症状` {name: "胃痛"})
RETURN d.name
LIMIT 25
'''
...
special_slot = {
    "病因":{
        "slot_list" : ["symptom"],
        "slot_values":None,
        "reply_template" : "'{symptom}' 症状可能是生了这种病：\n",
        "ask_template" : "您问的是 '{symptom}' 症状的生的病吗？",
        "intent_strategy" : "",
        "deny_response":"很抱歉我不知道这种病"
    },
    "推荐": {
        "slot_list": ["recommend","Disease","symptom","drug","food","department","crowd","treatment"],
        "slot_values": None,
        "reply_template": "好的，一下是我推荐您的'{recommend}'：\n",
        "ask_template": "您问的是推荐您相关的 '{recommend}' 吗？\n",
        "intent_strategy": "",
        "deny_response": "很抱歉我没能理解您的意思"
    },
    "个人评价": {
        "slot_list": ["evaluate"],
        "slot_values": None,
        "reply_template": "如下是您的身体健康情况：\n",
        "ask_template": "您问的是评价您的身体健康情况吗？",
        "intent_strategy": "",
        "deny_response": "很抱歉我没能理解"
    }
}
