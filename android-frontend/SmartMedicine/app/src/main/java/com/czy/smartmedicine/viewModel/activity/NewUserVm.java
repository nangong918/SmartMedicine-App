...
import com.czy.domain.ao.newUser.NewUserItemAo;
...
import com.czy.domain.fragmentActivityAo.NewUserGroupVo;
            ...
            this.listViewClickInstance = (position, buttonId, content) -> {
                ...
                // 处理方
                    ...
                    // 已取消
                        ...
                        Log.i(TAG, "已取消");
                        MainApplication.getInstance().showGlobalToast(com.czy.appview.R.string.canceled_add);
                    }
                }
            };
        }
