...
public class ThreadConfig {
    ...
    // 线程池相关配置
    private static final int CORE_POOL_SIZE = 8;    // 核心线程池大小
    private static final int MAX_POOL_SIZE = 80;    // 最大线程池大小
    private static final int QUEUE_CAPACITY = 250;  // 任务队列容量
    private static final int KEEP_ALIVE_SECONDS = 300;  // 线程空闲时间（秒）
    ...
    public ThreadPoolTaskExecutor taskExecutor() {
        ...
        poolTaskExecutor.setTaskDecorator(new TaskDecorator() {
            @NotNull
            @Override
    ...
    public ThreadPoolTaskExecutor ruleExecutor() {
        ...
        poolTaskExecutor.setThreadFactory(new CustomizableThreadFactory("ruleService-exec"));
        return poolTaskExecutor;
    }
}
