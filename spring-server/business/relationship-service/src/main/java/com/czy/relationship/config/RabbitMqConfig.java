package com.czy.relationship.config;
...
public class RabbitMqConfig {
    ...
    public DirectExchange deadLetterExchange() {
        return ExchangeBuilder.directExchange(RelationshipMqConstant.DEAD_LETTER_EXCHANGE)
                .durable(true)
                .build();
    }
    ...
    public Queue deadLetterQueue() {
        return QueueBuilder.durable(RelationshipMqConstant.DEAD_LETTER_QUEUE)
                .build();
    }
    ...
    public Binding deadLetterBinding() {
        return BindingBuilder.bind(deadLetterQueue())
                ...
                .with(RelationshipMqConstant.DEAD_LETTER_QUEUE);
    }
...
//                .withArgument("x-dead-letter-routing-key", SocketMessageMqConstant.DEAD_LETTER_QUEUE)
//                .build();
        return new Queue(RelationshipMqConstant.RELATION_SEND_MESSAGE_QUEUE, // Queue 名字
                true, // durable: 是否持久化
                false, // exclusive: 是否排它
