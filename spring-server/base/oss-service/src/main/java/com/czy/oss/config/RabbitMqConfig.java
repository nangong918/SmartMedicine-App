...
public class RabbitMqConfig {
    ...
    public DirectExchange deadLetterExchange() {
        return ExchangeBuilder.directExchange(OssMqConstant.DEAD_LETTER_EXCHANGE)
                .durable(true)
                .build();
    }
    ...
    public Queue deadLetterQueue() {
        return QueueBuilder.durable(OssMqConstant.DEAD_LETTER_QUEUE)
                .build();
    }
    ...
    public Binding deadLetterBinding() {
        return BindingBuilder.bind(deadLetterQueue())
                ...
                .with(OssMqConstant.DEAD_LETTER_QUEUE);
    }
...
//                .build();
        return new Queue(OssMqConstant.OSS_TO_SERVICE_QUEUE, // Queue 名字
                true, // durable: 是否持久化
