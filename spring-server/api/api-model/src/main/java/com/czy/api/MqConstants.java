...
//        String IMPLICIT_BEHAVIOR_QUEUE = "socket" + R.IMPLICIT + QUEUE_KEY;
    ...
    interface PayQueue {
        ...
        interface Routing {
            ...
            String APPOINTMENT_PAY_DEATH_ROUTING = ".appointment" + DEATH + ID;
            ...
            String PURCHASE_PAY_DEATH_ROUTING = ".purchase" + DEATH + ID;
        ...
        String APPOINTMENT_PAY_DEATH_QUEUE = Routing.APPOINTMENT_PAY_DEATH_ROUTING + QUEUE; // exchange: PAY_RESULT_EXCHANGE
        ...
        String PURCHASE_PAY_DEATH_QUEUE = Routing.PURCHASE_PAY_DEATH_ROUTING + QUEUE;
