...
//    static String DLX = ".dlx";
    /*
        1. 消息需要从netty-socket发送给service
        2. netty-socket也需要接收各个service发送的消息
     */
    static String TO_SOCKET = ".to_socket";
    static String TO_SERVICE = ".to_service";
...
//        }
    ...
    public interface MessageQueue {
        String ID = ".message";
        String MESSAGE_TO_SOCKET_QUEUE = TO_SOCKET + ID + QUEUE;
        String MESSAGE_TO_SERVICE_QUEUE = TO_SERVICE + ID + QUEUE;
...
//        String MESSAGE_TO_GROUP_FILE_QUEUE = "socket" + R.MESSAGE + R.TO_GROUP + R.FILE + QUEUE_KEY;
    ...
    public interface PostQueue {
        String ID = ".post";
        String POST_TO_SOCKET_QUEUE = TO_SOCKET + ID + QUEUE;
        String POST_TO_SERVICE_QUEUE = TO_SERVICE + ID + QUEUE;
//        interface R {
//            String POST = ".post";
...
//        String POST_COMMENT_QUEUE = "socket" + R.COMMENT + QUEUE_KEY;
    ...
    public interface RelationshipQueue {
        ...
        String RELATIONSHIP_TO_SOCKET_QUEUE = TO_SOCKET + ID + QUEUE;
        String RELATIONSHIP_TO_SERVICE_QUEUE = TO_SERVICE + ID + QUEUE;
//        interface R {
//            String RELATIONSHIP = ".relationship";
...
//        String OSS_QUEUE = "socket.oss.queue";
        String ID = ".oss";
        String OSS_TO_SOCKET_QUEUE = TO_SOCKET + ID + QUEUE;
        String OSS_TO_SERVICE_QUEUE = TO_SERVICE + ID + QUEUE;
    }
...
//        String IMPLICIT_BEHAVIOR_QUEUE = "socket" + R.IMPLICIT + QUEUE_KEY;
    ...
    public interface DeadLetterQueue {
        ...
        String MESSAGE_DEAD_LETTER_QUEUE = MessageQueue.ID + ID + QUEUE;
        String POST_DEAD_LETTER_QUEUE = PostQueue.ID + ID + QUEUE;
        String RELATIONSHIP_DEAD_LETTER_QUEUE = RelationshipQueue.ID + ID + QUEUE;
        String OSS_DEAD_LETTER_QUEUE = OssQueue.ID + ID + QUEUE;
