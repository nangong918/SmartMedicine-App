 ...
 */
@Data
public class PostFVo implements Serializable, Cloneable {
    public PostFVo(){}
    public PostFVo(PostVo postVo){
        this.postId = postVo.postId;
        this.authorAvatarUrl = postVo.authorAvatarUrl;
        this.authorName = postVo.authorName;
        ...
        this.collectNum = NumberUtils.numToString(postVo.collectNum);
        this.commentNum = NumberUtils.numToString(postVo.commentNum);
        this.forwardNum = NumberUtils.numToString(postVo.forwardNum);
        this.nerResults = postVo.nerResults;
        this.timestamp = postVo.timestamp;
        this.popularity = postVo.popularity;
        this.postImgUrls = postVo.postImgUrls;
        this.score = postVo.score;
        this.like = postVo.like;
        this.collect = postVo.collect;
        this.dislike = postVo.dislike;
    }
    ...
    @NotNull
    @Override
    public PostFVo clone() throws CloneNotSupportedException {
        PostFVo cloned = (PostFVo) super.clone();
