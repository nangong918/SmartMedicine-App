...
public class PostMqConstant {
    ...
    // 死信队列
    // 死信队列名称
    public static final String DEAD_LETTER_QUEUE = "post.to.oss.dead.letter.queue";
    // 为每个队列定义死信交换机
    public static final String DEAD_LETTER_EXCHANGE = "post.to.oss.dead.letter.exchange";
}
